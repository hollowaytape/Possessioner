...
def encode(filename):
    ...
    target_colors = [
        ((0xff, 0xff, 0xff), (0x55, 0x55, 0x55), (0x44, 0x22, 0x11)),  # grey, brown
        ((0xff, 0xff, 0xff), (0x00, 0x11, 0x33), (0x66, 0x33, 0x22)),   # blue, pink
        ((0xff, 0xff, 0xff), (0x55, 0x55, 0x55), (0x00, 0x11, 0x33),),                     # grey
        ((0xff, 0xff, 0xff), (0x11, 0x55, 0x55),),                     # cyan
    ]
...
if __name__ == "__main__":
    #filenames = ['lm2.png']
    filenames = ["p4.png", "p5.png", 'lm2.png']
    #filenames = ['p4.png']
